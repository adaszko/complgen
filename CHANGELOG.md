 ...
 * fish: Shorter output scripts

## 0.10.1
### Fixed

 * Fix fish bug where there were too many subword completions

### Changed

 * Sped up fish completion scripts by reducing number of shell-outs

## 0.10.0
### Fixed

 * Fixed sub-DFAs interning resulting in smaller output scripts across all shells
 ...
 * It's now possible to to use dots in literals by backslash-escaping them
 ...
 * `entered unreachable code` bug (#71)

## 0.8.2
### Fixed

 * Bug in zsh output where lookup tables weren't properly reset

## 0.8.1
### Fixed

 * Bugs in fish and pwsh related to handling overlapping completions
